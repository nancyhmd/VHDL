...
add wave -hex -label "Registre R1"              {sim:/tb_solomono_processor/UUT/PROCESSING_UNIT/REG_FILE_INST/Banc(1)}
add wave -hex -label "Registre R2 (Accumulateur)" {sim:/tb_solomono_processor/UUT/PROCESSING_UNIT/REG_FILE_INST/Banc(2)}
